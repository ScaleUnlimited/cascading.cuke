...
public class CascadingFormatterTest {
	...
	public void testWordCountFlow() throws Throwable {
		...
		featureSource.append("Then the com.scaleunlimited.cascading.cuke.CascadingFormatterTest$WordCountCounters.TOTAL_WORDS counter value is 16\n");
		featureSource.append("Then the WordCountCounters.FREQUENCY_BY_WORD.the counter value is 2\n");
		featureSource.append("Then the WordCountCounters.FREQUENCY_BY_WORD.to counter value is at least 2\n");
		featureSource.append("Then the WordCountCounters.FREQUENCY_BY_WORD.good counter value is >=1\n");
		featureSource.append("Then the WordCountCounters.FREQUENCY_BY_WORD.their counter value is at most 1\n");
		featureSource.append("Then the WordCountCounters.FREQUENCY_BY_WORD.men counter value is greater than 0\n");
		featureSource.append("Then the WordCountCounters.FREQUENCY_BY_WORD.come counter value is less than 2\n");
